...
export const instructorLearnerMasteryApi = {
  get: (courseId: string, signal?: AbortSignal): Promise<InstructorLearnerMasteryResponse> =>
    apiFetch(`/instructor/courses/${encodeURIComponent(courseId)}/learner-mastery`, { signal }),
};
